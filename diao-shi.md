...
![](/assets/WechatIMG51.jpeg)点击debugger进入调试界面（此时界面会重新刷新一次，如果你自己接入的sdk，把开启debug卸载application里面，那么界面非要在你点了debugger之后才出来，哎，又是一个踩过的坑），如果你有过浏览器js调试经验，那么剩下的就跟那完全一样了，为了讲清楚，我继续截图
